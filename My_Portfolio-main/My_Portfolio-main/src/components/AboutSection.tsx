        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
          ...
          <div className="space-y-6">
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              and attack pattern analysis. I am a curious person and eager to learn and contribute to protecting systems and data from cyber threats.
            </p>
            <p className="text-muted-foreground leading-relaxed">
              I want to build a career as a cybersecurity professional. I am a curious person and eager to learn and contribute to protecting systems and data from cyber threats..
            </p>
          ...
          <div className="relative">
            <Card className="bg-glass p-8 text-center">
              ...
              <h4 className="text-xl font-semibold mb-2">Cybersecurity Student</h4>
